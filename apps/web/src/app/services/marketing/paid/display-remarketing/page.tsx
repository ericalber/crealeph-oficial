...
export default function MarketingPaidDisplayRemarketingPage() {
  return (
    <section className="px-4 py-16">
      <div className="mx-auto max-w-screen-xl space-y-6 lg:px-8">
        <nav aria-label="Breadcrumb" className="text-xs uppercase tracking-[0.3em] text-muted">
          ...
          <span className="mx-2">›</span>
          <span className="text-ink">Display & Remarketing</span>
        </nav>
        <h1 className="text-3xl font-semibold text-ink">Display & Remarketing</h1>
        <div className="grid gap-8 md:grid-cols-2">
          <article className="rounded-[--radius] border border-line bg-white p-6 shadow-sm">
            ...
            <ul className="mt-3 list-disc pl-6 text-sm text-muted">
              <li>Awareness strategy</li>
              <li>Segments and lists for remarketing</li>
              <li>Measurement by cohorts</li>
            </ul>
          </article>
        </div>
      </div>
