...
export default function MarketingPaidSearchPage() {
  return (
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <article className="rounded-[--radius] border border-line bg-white p-6 shadow-sm">
            ...
            <ul className="mt-3 list-disc pl-6 text-sm text-muted">
              <li>Keyword strategy and account structure</li>
              <li>Performance campaigns and landing pages</li>
              <li>Measurement with Bridge and attribution</li>
            </ul>
          </article>
        </div>
      </div>
